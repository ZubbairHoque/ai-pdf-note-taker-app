...
class AutoBatchQueue {
    ...
    push(item) {
        ...
        const size = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(item.item).length;
        this.items.push({
            action: item.action,
            payload: item.item,
...
class Client {
    ...
    async createRun(run) {
        ...
        const response = await this.caller.call((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$singletons$2f$fetch$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_getFetchImplementation"])(), `${this.apiUrl}/runs`, {
            method: "POST",
            headers,
            body: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(mergedRunCreateParam),
            signal: AbortSignal.timeout(this.timeout_ms),
            ...this.fetchOptions
        });
     ...
     */ async batchIngestRuns({ runCreates, runUpdates }) {
        ...
        if (batchChunks.post.length > 0 || batchChunks.patch.length > 0) {
            await this._postBatchIngestRuns((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(batchChunks));
        }
    }
     ...
     */ async multipartIngestRuns({ runCreates, runUpdates }) {
        ...
        for (const [method, payloads] of [
            ...
            for (const originalPayload of payloads){
                ...
                const stringifiedPayload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(payload);
                ...
                for (const [key, value] of Object.entries(fields)){
                    ...
                    const stringifiedValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(value);
                    accumulatedParts.push({
    ...
    async updateRun(runId, run) {
        ...
        const response = await this.caller.call((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$singletons$2f$fetch$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_getFetchImplementation"])(), `${this.apiUrl}/runs/${runId}`, {
            method: "PATCH",
            headers,
            body: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(run),
            signal: AbortSignal.timeout(this.timeout_ms),
            ...this.fetchOptions
        });
     ...
     */ async updateDatasetTag(props) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$_uuid$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertUuid"])(_datasetId);
        const response = await this.caller.call((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$singletons$2f$fetch$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_getFetchImplementation"])(), `${this.apiUrl}/datasets/${_datasetId}/tags`, {
            method: "PUT",
            headers: {
                ...this.headers,
                "Content-Type": "application/json"
     ...
     */ async readDatasetVersion({ datasetId, datasetName, asOf, tag }) {
        ...
        const response = await this.caller.call((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$singletons$2f$fetch$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_getFetchImplementation"])(), `${this.apiUrl}/datasets/${resolvedDatasetId}/version?${params.toString()}`, {
            method: "GET",
            headers: {
                ...this.headers
            },
    ...
    async _updateExamplesMultipart(datasetId, updates = []) {
        ...
        for (const example of updates){
            ...
            const stringifiedExample = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(exampleBody);
            ...
            if (example.inputs) {
                const stringifiedInputs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(example.inputs);
            ...
            if (example.outputs) {
                const stringifiedOutputs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(example.outputs);
            ...
            if (example.attachments_operations) {
                const stringifiedAttachmentsOperations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$utils$2f$fast$2d$safe$2d$stringify$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serialize"])(example.attachments_operations);
        ...
        const response = await this.caller.call((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$singletons$2f$fetch$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_getFetchImplementation"])(), `${this.apiUrl}/v1/platform/datasets/${datasetIdToUse}/examples`, {
            method: "PATCH",
            headers: this.headers,
            body: formData
        });
    ...
    async _uploadExamplesMultipart(datasetId, uploads = []) {
        ...
        const response = await this.caller.call((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langsmith$2f$dist$2f$singletons$2f$fetch$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_getFetchImplementation"])(), `${this.apiUrl}/v1/platform/datasets/${datasetId}/examples`, {
            method: "POST",
            headers: this.headers,
            body: formData
        });
