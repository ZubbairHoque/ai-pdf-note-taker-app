...
function EditorExtension({ editor, note }: any) {
  ...
  // Add state for note viewer visibility with a default of false
  const [showNote, setShowNote] = useState(false);
  
  // Debug notes data
  console.log("Notes in EditorExtension:", note);
  console.log("Note type:", typeof note, "Note is array:", Array.isArray(note), "Note length:", Array.isArray(note) ? note.length : 0);
  
  // Effect to handle changes in the notes data
  useEffect(() => {
    console.log("Notes updated:", note);
    // If notes are loaded and the panel is not showing, you could optionally show a notification
    // that notes are available
  }, [note]);
  
  // Effect to log when showNote changes
  useEffect(() => {
    ...
    editor && (
      <div className="p-5 ">
        <div className="control-group flex flex-wrap gap-2 items-center">
          {/* Bordered div for heading buttons only */}
          ...
          {/* Other toolbar buttons, outside the border */}
          <button
            onClick={() => editor.chain().focus().toggleBold().run()}
            className={editor.isActive("bold") ? "text-blue-500 relative group" : "relative group"}
          >
            <Bold />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Bold
          ...
          <button
            ...
            className={editor.isActive("italic") ? "text-blue-500 relative group" : "relative group"}
          >
            <Italic />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Italic
          ...
          <button
            ...
            className={editor.isActive("underline") ? "text-blue-500 relative group" : "relative group"}
          >
            <Underline />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Underline
          ...
          <button
            ...
            className={editor.isActive("code") ? "text-blue-500 relative group" : "relative group"}
          >
            <Code />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Code
          ...
          <button
            ...
            className={editor.isActive("bulletList") ? "text-blue-500 relative group" : "relative group"}
          >
            <List />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Bullet List
          ...
          <button
            ...
            className={editor.isActive("blockquote") ? "text-blue-500 relative group" : "relative group"}
          >
            <TextQuote />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Blockquote
          ...
          <button
            ...
            className={editor.isActive("highlight") ? "text-blue-500 relative group" : "relative group"}
          >
            <Highlighter />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Highlight
          ...
          <button
            ...
            className={editor.isActive("strike") ? "text-blue-500 relative group" : "relative group"}
          >
            <Strikethrough />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Strikethrough
          ...
          <button
            ...
            className={editor.isActive({ textAlign: "left" }) ? "text-blue-500 relative group" : "relative group"}
          >
            <AlignLeft />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Align Left
          ...
          <button
            ...
            className={editor.isActive({ textAlign: "center" }) ? "text-blue-500 relative group" : "relative group"}
          >
            <AlignCenter />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Align Center
          ...
          <button
            ...
            className={editor.isActive({ textAlign: "right" }) ? "text-blue-500 relative group" : "relative group"}
          >
            <AlignRight />
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">
              Align Right
          ...
          {/* Always show the notebook button, but only enable it if notes exist */}
          <button
            className="relative group hover:text-blue-500"
            onClick={() => {
              console.log("Notebook button clicked, setting showNote to true");
              setShowNote(true);
            }}
          ...
          {/* Notes panel - shown when showNote is true */}
          {showNote && (
            <div className="fixed top-0 right-0 h-full w-[500px] bg-white shadow-lg z-50 overflow-y-auto p-6 border-l border-gray-300">
              ...
              <div className="space-y-4 max-h-[90vh] overflow-y-auto pr-2">
                {!note ? (
                  <div className="text-center py-10 text-gray-400">Loading notes...</div>
                    ...
                    >
                      <div className="absolute top-2 right-2 flex gap-2">
                        <button
                          ...
                          onClick={() => toast("Edit feature not implemented yet.")}
                        >
                          Edit
                        </button>
                        <button
                      ...
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: typeof n.note === "string" ? n.note : JSON.stringify(n.note),
                        }}
                      />
                    </div>
                  ))
                  ...
                  <div className="text-center py-10">
                    <p className="text-gray-500 mb-2">No notes found for this document.</p>
                    <p className="text-sm text-gray-400">Notes you create will appear here.</p>
                  </div>
                )}
              </div>
            </div>
